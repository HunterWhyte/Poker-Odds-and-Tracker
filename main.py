...
oddscalculatorlabel.grid(column = 7, row = 1, sticky = "w")

hand1oddslabel = Label(window, text="0.00%", font=lg)
hand1oddslabel.grid(column = 8, row = 4, columnspan = 4, sticky = "w")
...
hand1card1entry.grid(column = 8, row = 3, sticky = "w")
hand1card2entry.grid(column = 9, row = 3, sticky = "w")
...
flopcard1entry.grid(column = 10, row = 5, sticky = "w")
flopcard2entry.grid(column = 11, row = 5, sticky = "w")
flopcard3entry.grid(column = 12, row = 5, sticky = "w")
turncardentry.grid(column = 13, row = 5, sticky = "w")
rivercardentry.grid(column = 14, row = 5, sticky = "w")
...
hand2card1entry.grid(column = 15, row = 3, sticky = "w")
hand2card2entry.grid(column = 16, row = 3, sticky = "w")
...
calculateoddsbutton.grid(column = 10, row = 7, columnspan = 5)
