...
# BU headsup 10-15 BB
buheadsuptenkey = ["fold","limp-call","limp-fold","limp-shove","all-in"]
    ...
    if n == 2:
        if pos == "n":
            ...
            if act == 1:
                ...
                return None # BUTTON 10-15 BB
            elif act == 3:
                return None # BUTTON 7-9 BB
        elif pos == "BB":
            if act == 1:
                return None # BB vs Button limp
            elif act == 2:
                return None # BB vs BU min raise
            elif act == 3:
                return None # BB vs BU shove 7-9
    elif n == 3:
        if pos == "BB":
            if act == 1:
                return None # BB vs BU min raise
            elif act == 2:
                return None # BB vs SB 2.5
            elif act == 3:
                return None # BB vs BU limp
            elif act == 4:
                return None # BB vs SB limp
        elif pos == "SB":
            if act == 1:
                return None # SB vs BU minraise
            if act == 2:
